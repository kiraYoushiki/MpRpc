...
class RpcHeader :
 ...
 public:
  ...
  // uint32 argv_size = 3;
  void clear_argv_size();
  ::PROTOBUF_NAMESPACE_ID::uint32 argv_size() const;
  void set_argv_size(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_argv_size() const;
  void _internal_set_argv_size(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 argv_size_;
...
// uint32 argv_size = 3;
inline void RpcHeader::clear_argv_size() {
  argv_size_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::_internal_argv_size() const {
  return argv_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::argv_size() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.argv_size)
  return _internal_argv_size();
}
inline void RpcHeader::_internal_set_argv_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  argv_size_ = value;
}
inline void RpcHeader::set_argv_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_argv_size(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.argv_size)
}
