...
class GetFriendListsResonseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListsResonse> _instance;
} _GetFriendListsResonse_default_instance_;
}  // namespace fixbug
...
static void InitDefaultsscc_info_GetFriendListsResonse_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListsResonse_default_instance_;
    new (ptr) ::fixbug::GetFriendListsResonse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListsResonse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListsResonse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListsResonse_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResonse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResonse, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResonse, friends_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 35, -1, sizeof(::fixbug::GetFriendListsResonse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListsResonse_default_instance_),
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ser.Sex\"\031\n\003Sex\022\007\n\003MAN\020\000\022\t\n\005WOMAN\020\001\"Z\n\025Ge"
  "tFriendListsResonse\022\"\n\006result\030\001 \001(\0132\022.fi"
  "xbug.ResultCode\022\035\n\007friends\030\002 \003(\0132\014.fixbu"
  "g.User2\226\001\n\016UserServiceRpc\0224\n\005Login\022\024.fix"
  "bug.LoginRequest\032\025.fixbug.LoginResponse\022"
  "N\n\016GetFriendLists\022\035.fixbug.GetFriendList"
  "sRequest\032\035.fixbug.GetFriendListsResonseB"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  ...
  &scc_info_GetFriendListsResonse_test_2eproto.base,
...
void GetFriendListsResonse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListsResonse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListsResonse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListsResonse* msg);
};

const ::fixbug::ResultCode&
GetFriendListsResonse::_Internal::result(const GetFriendListsResonse* msg) {
  return *msg->result_;
}
GetFriendListsResonse::GetFriendListsResonse()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListsResonse)
}
GetFriendListsResonse::GetFriendListsResonse(const GetFriendListsResonse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListsResonse)
}

void GetFriendListsResonse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListsResonse_test_2eproto.base);
  result_ = nullptr;
}

GetFriendListsResonse::~GetFriendListsResonse() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListsResonse)
  SharedDtor();
}

void GetFriendListsResonse::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListsResonse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListsResonse& GetFriendListsResonse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListsResonse_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListsResonse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListsResonse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListsResonse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsResonse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListsResonse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListsResonse)
  return target;
}

size_t GetFriendListsResonse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsResonse)
  size_t total_size = 0;
...
void GetFriendListsResonse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListsResonse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsResonse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsResonse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListsResonse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListsResonse)
    MergeFrom(*source);
  }
}

void GetFriendListsResonse::MergeFrom(const GetFriendListsResonse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsResonse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListsResonse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListsResonse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListsResonse::CopyFrom(const GetFriendListsResonse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListsResonse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListsResonse::IsInitialized() const {
  return true;
}

void GetFriendListsResonse::InternalSwap(GetFriendListsResonse* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListsResonse::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListsResonse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendListsResonse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRpc_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              ...
                              ::fixbug::GetFriendListsResonse* response,
                              ::google::protobuf::Closure* done) {
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsResonse* Arena::CreateMaybeMessage< ::fixbug::GetFriendListsResonse >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListsResonse >(arena);
}
