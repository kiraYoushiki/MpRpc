...
class GetFriendListsResonse;
class GetFriendListsResonseDefaultTypeInternal;
extern GetFriendListsResonseDefaultTypeInternal _GetFriendListsResonse_default_instance_;
class LoginRequest;
...
template<> ::fixbug::GetFriendListsResonse* Arena::CreateMaybeMessage<::fixbug::GetFriendListsResonse>(Arena*);
...
class GetFriendListsResonse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsResonse) */ {
 public:
  GetFriendListsResonse();
  virtual ~GetFriendListsResonse();

  GetFriendListsResonse(const GetFriendListsResonse& from);
  GetFriendListsResonse(GetFriendListsResonse&& from) noexcept
    : GetFriendListsResonse() {
    *this = ::std::move(from);
  }

  inline GetFriendListsResonse& operator=(const GetFriendListsResonse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsResonse& operator=(GetFriendListsResonse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListsResonse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListsResonse* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsResonse*>(
               &_GetFriendListsResonse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendListsResonse& a, GetFriendListsResonse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsResonse* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListsResonse* New() const final {
    return CreateMaybeMessage<GetFriendListsResonse>(nullptr);
  }

  GetFriendListsResonse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListsResonse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListsResonse& from);
  void MergeFrom(const GetFriendListsResonse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsResonse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsResonse";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsResonse)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListsResonse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListsResonse::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsResonse::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsResonse::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsResonse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResonse.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendListsResonse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsResonse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsResonse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListsResonse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResonse.result)
  return _internal_mutable_result();
}
inline void GetFriendListsResonse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsResonse.result)
}

// repeated .fixbug.User friends = 2;
inline int GetFriendListsResonse::_internal_friends_size() const {
  return friends_.size();
}
inline int GetFriendListsResonse::friends_size() const {
  return _internal_friends_size();
}
inline void GetFriendListsResonse::clear_friends() {
  friends_.Clear();
}
inline ::fixbug::User* GetFriendListsResonse::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResonse.friends)
  return friends_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResonse::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResonse.friends)
  return &friends_;
}
inline const ::fixbug::User& GetFriendListsResonse::_internal_friends(int index) const {
  return friends_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResonse::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResonse.friends)
  return _internal_friends(index);
}
inline ::fixbug::User* GetFriendListsResonse::_internal_add_friends() {
  return friends_.Add();
}
inline ::fixbug::User* GetFriendListsResonse::add_friends() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResonse.friends)
  return _internal_add_friends();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResonse::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResonse.friends)
  return friends_;
}
